import { c as createLucideIcon, j as jsxRuntimeExports, A as Root, D as Content, E as Close, X, d as cn, G as Title, H as Description, J as Portal, O as Overlay, K as useParams, a as useNavigate, M as useInvoice, N as useUpdateInvoicePaymentStatus, Q as useDeleteInvoice, V as useSendInvoiceEmail, r as reactExports, W as useCustomer, B as Button, t as Card, Y as Separator, v as PaymentStatus, e as ue, Z as Trash2, o as Skeleton, w as InvoiceStatus } from "./index-DHdUgTPk.js";
...
import { M as MailCheck } from "./mail-check-DY56rVNJ.js";
...
function BillDetail() {
  ...
  const [emailDialogOpen, setEmailDialogOpen] = reactExports.useState(false);
  const { data: customer } = useCustomer((invoice == null ? void 0 : invoice.customerId) ?? null);
  ...
  const handleSendEmail = () => {
    ...
    sendEmail(invoice.invoiceId, {
      onSuccess: () => {
        ue.success("Invoice emailed successfully!");
  ...
  const customerEmail = (customer == null ? void 0 : customer.email) ?? void 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    invoice && !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "no-print fixed bottom-0 left-0 right-0 z-40 bg-background/95 backdrop-blur-sm border-t border-border/50 px-4 py-3 max-w-md mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      ...
      !invoice.customerId ? null : !canEmail ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          variant: "outline",
          className: "h-11 px-3 rounded-xl border-border text-muted-foreground",
          onClick: () => ue.info("Customer has no email address"),
      ...
      ) : invoice.emailSent ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          variant: "outline",
          ...
          type: "button",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MailCheck, { size: 15 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium", children: "Sent" })
          ]
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium hidden sm:inline", children: "Email" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    invoice && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: emailDialogOpen, onOpenChange: setEmailDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { "data-ocid": "bill_detail.email_dialog", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 18, className: "text-primary" }),
          invoice.emailSent ? "Resend Invoice" : "Send Invoice"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: canEmail ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          "Send invoice",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: invoice.invoiceNumber }),
          " ",
          "to",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: customerEmail }),
          "?",
          invoice.emailSent && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block mt-1 text-amber-600 text-xs", children: "This invoice was already emailed. Sending again will deliver a duplicate." })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            type: "button",
            children: sendingEmail ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
